			...
			<div className="container mx-auto px-4">
				<div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
					...
					<div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg relative">
						{/* Quote Icon */}
						<div className="absolute left-8 text-9xl text-gray-200 font-serif">
							&ldquo;
						</div>
						...
						<div className="mt-16">
							...
							<p
								...
								style={{ fontFamily: "Poppins, sans-serif" }}
							>
								Terwujudnya kesetaraan kesempatan bagi setiap anak autisme di
								Indonesia untuk bertumbuh dan mencapai potensi terbaik mereka,
								didukung oleh teknologi terapi yang inovatif, terjangkau, dan
