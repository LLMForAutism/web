			...
			<div className="flex container mx-auto px-4 gap-20 flex-col md:flex-row">
				<div className="w-full order-2 md:order-1 md:w-1/2 md:max-w-1/2">
					<p>
						...
						teknologi dapat menjadi jembatan untuk menciptakan terapi yang lebih
						mudah diakses, terjangkau, dan efektif bagi anak-anak dan keluarga
					...
					<p>
						Mewujudkan sistem terapi berbasis AI yang inklusif, mudah diakses,
						dan terjangkau untuk mendukung perkembangan anak-anak dengan autisme
						di Indonesia.
					</p>
					...
					<ul>
						...
						<li>
							...
							memastikan setiap inovasi selaras dengan kebutuhan nyata di
							lapangan.
						</li>
						<li>
							Memberikan edukasi kepada masyarakat tentang pemanfaatan teknologi
							untuk mendukung inklusivitas dan pemahaman terhadap autisme.
						</li>
						<li>
							Mendorong keterlibatan relawan dan peneliti untuk bersama-sama
							menciptakan solusi terbuka (open-source) yang bermanfaat luas.
						</li>
					</ul>
				</div>
